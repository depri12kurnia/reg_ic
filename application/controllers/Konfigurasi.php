...
class Konfigurasi extends CI_Controller
{
	...
	public function email_setting()
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			redirect(base_url('konfigurasi/email_setting'));
		}
	}
	...
	public function setting()
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			$this->konfigurasi_model->edit($data);
			$this->session->set_flashdata('sukses', 'Site configuration updated successfully');
			redirect(base_url('konfigurasi/setting'));
		}
	}
	...
	public function logo()
	{
		...
		if ($v->run()) {
			...
			if (!$this->upload->do_upload('logo')) {
				...
				redirect(base_url('konfigurasi/logo'));
			}
		}
		// Default page
		$data = array(
	...
	public function direktur()
	{
		...
		if ($v->run()) {
			...
			if (!$this->upload->do_upload('stempel_tanda_tangan')) {
				...
				redirect(base_url('konfigurasi/direktur'));
			}
		}
		// Default page
		$data = array(
	...
	public function icon()
	{
		...
		if ($v->run()) {
			...
			if (!$this->upload->do_upload('icon')) {
				...
				redirect(base_url('konfigurasi/icon'));
			}
		}
		// Default page
		$data = array(
	...
	public function footer()
	{
		...
		if ($v->run()) {
			...
			if (!$this->upload->do_upload('footer')) {
				...
				redirect(base_url('konfigurasi/footer'));
			}
		}
		// Default page
		$data = array(
	...
	public function banner()
	{
		...
		if ($v->run()) {
			...
			if (!$this->upload->do_upload('banner')) {
				...
				$this->konfigurasi_model->edit($data);
				$this->session->set_flashdata('sukses', 'Logo changed');
				redirect(base_url('konfigurasi/banner'));
			}
		}
		// Default page
		$data = array(
	...
	public function quote()
	{
		...
		if ($this->form_validation->run() === FALSE) {
			...
			$this->konfigurasi_model->edit($data);
			$this->session->set_flashdata('sukses', 'Site configuration updated successfully');
			redirect(base_url('konfigurasi/quote'));
		}
	}
		...
		if ($v->run()) {
			if (!empty($_FILES['gambar']['name'])) {
				...
				if (!$this->upload->do_upload('gambar')) {
					...
					redirect(base_url('konfigurasi/javawebmedia'));
				}
			} else {
				$i = $this->input;
				$data = array(
