	...
	<div class="col-md-3">
		<div class="form-group">
			...
			<select name="akses_level" class="form-control">
				...
				<option value="Verifikator" <?php if ($user->akses_level == "Verifikator") {
												echo "selected";
											} ?>>Verifikator</option>
				<option value="Absensi" <?php if ($user->akses_level == "Absensi") {
											echo "selected";
										} ?>>Absensi</option>
			</select>
		</div>
		...
		<div class="form-group">
			...
			<select name="id_bagian" class="form-control">
				...
				<?php foreach ($bagian as $bagian) { ?>
					<option value="<?php echo $bagian->id_bagian ?>" <?php if ($user->id_bagian == $bagian->id_bagian) {
																			echo "selected";
																		} ?>>
	...
	<div class="col-md-12">
		<div class="form-group">
			<div class="btn-group">
				...
				<a href="<?php echo base_url('user') ?>" class="btn btn-warning btn-lg">
